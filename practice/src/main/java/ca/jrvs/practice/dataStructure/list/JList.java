 ...
 *
 * @see java.util.List for JSDK full version of List
 *
 */
public interface JList<E> {
   ...
   * in this list, or -1 if this list does nopt contain the element.
  ...
  /**
   * Removes all the elements from this ;ist (optional operation).
